...
@Client.on_message(command("SONG_COMMAND") & filters.group & ~BANNED_USERS)
@language
    ...
    upl = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text=_["SG_B_1"],
                    url=f"https://t.me/{client.username}?start=song",
                ),
            ]
        ]
    )
...
@Client.on_message(command("SONG_COMMAND") & filters.private & ~BANNED_USERS)
@language
...
@Client.on_callback_query(filters.regex(pattern=r"song_back") & ~BANNED_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex(pattern=r"song_helper") & ~BANNED_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex(pattern=r"song_download") & ~BANNED_USERS)
@languageCB
