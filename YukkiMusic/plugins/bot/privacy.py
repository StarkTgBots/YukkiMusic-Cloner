...
@Client.on_message(command("PRIVACY_COMMAND") & ~BANNED_USERS)
...
@Client.on_callback_query(filters.regex("show_privacy_sections") & ~BANNED_USERS)
...
@Client.on_callback_query(filters.regex("privacy_") & ~BANNED_USERS)
...
@Client.on_callback_query(filters.regex("retrieve_data"))
...
@Client.on_callback_query(filters.regex("delete_data"))
...
@Client.on_callback_query(filters.regex("confirm_delete_data"))
