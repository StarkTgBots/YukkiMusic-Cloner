...
@Client.on_message(command("HELP_COMMAND") & filters.private & ~BANNED_USERS)
...
@Client.on_message(command("HELP_COMMAND") & filters.group & ~BANNED_USERS)
@LanguageStart
async def help_com_group(client, message: Message, _):
    keyboard = private_help_panel(_,message.chat.id)
