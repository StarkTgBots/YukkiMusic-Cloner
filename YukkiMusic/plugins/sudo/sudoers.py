...
@Client.on_message(command("ADDSUDO_COMMAND") & filters.user(OWNER_ID))
@language
...
@Client.on_message(command("DELSUDO_COMMAND") & filters.user(OWNER_ID))
@language
...
@Client.on_message(command("SUDOUSERS_COMMAND") & ~BANNED_USERS)
@language
