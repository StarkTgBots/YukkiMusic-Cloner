...
@Client.on_message(command("BLOCK_COMMAND") & SUDOERS)
@language
...
@Client.on_message(command("UNBLOCK_COMMAND") & SUDOERS)
@language
...
@Client.on_message(command("BLOCKED_COMMAND") & SUDOERS)
@language
async def sudoers_list(client, message: Message, _):
    ...
    for users in BANNED_USERS:
        try:
            user = await client.get_users(users)
