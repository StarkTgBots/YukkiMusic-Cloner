...
@Client.on_message(command("BLACKLISTCHAT_COMMAND") & SUDOERS)
@language
...
@Client.on_message(command("WHITELISTCHAT_COMMAND") & SUDOERS)
@language
...
@Client.on_message(command("BLACKLISTEDCHAT_COMMAND") & ~BANNED_USERS)
@language
