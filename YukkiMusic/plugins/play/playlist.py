...
@Client.on_message(command("PLAYLIST_COMMAND") & ~BANNED_USERS)
@language
...
@Client.on_message(command("DELETE_PLAYLIST_COMMAND") & filters.group & ~BANNED_USERS)
@language
    ...
    upl = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text=_["PL_B_6"],
                    url=f"https://t.me/{client.username}?start=delplaylists",
                ),
            ]
        ]
    )
...
@Client.on_message(command("DELETE_PLAYLIST_COMMAND") & filters.private & ~BANNED_USERS)
@language
...
@Client.on_message(command("PLAY_PLAYLIST_COMMAND") & ~BANNED_USERS & filters.group)
@languageCB
