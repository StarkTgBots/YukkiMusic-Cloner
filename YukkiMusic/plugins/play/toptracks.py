...
@Client.on_callback_query(filters.regex("get_playmarkup") & ~BANNED_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("get_top_playlists") & ~BANNED_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("SERVERTOP") & ~BANNED_USERS)
@languageCB
