...
@Client.on_message(command("AUTH_COMMAND") & filters.group & ~BANNED_USERS)
@AdminActual
...
@Client.on_message(command("UNAUTH_COMMAND") & filters.group & ~BANNED_USERS)
@AdminActual
...
@Client.on_message(command("AUTHUSERS_COMMAND") & filters.group & ~BANNED_USERS)
@language
