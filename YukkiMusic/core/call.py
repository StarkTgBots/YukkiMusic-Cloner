...
class Call:
    ...
    async def join_chat(self, chat_id, app, attempts=1):
        ...
        try:
            ...
            raise AssistantErr(_["call_3"].format(mention, type(e).__name__))
        if chat_id in links:
            ...
            if chat.username:
                ...
                try:
                    ...
                    mention = user.mention
                    raise AssistantErr(
                        _["call_3"].format(mention, type(e).__name__)
                    )
        ...
        try:
            ...
            user = await app.get_me()
            mention = user.mention
            raise AssistantErr(_["call_6"].format(mention))
...
#                video_flags=MediaStream.Flags.IGNORE to do
        ...
        try:
            ...
            await self.join_chat(chat_id,app)
            try:
                await assistant.play(
                    chat_id=chat_id,
                    stream=stream,
